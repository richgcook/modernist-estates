...
export default defineType({
	...
	fields: [
		...
		defineField({
			...
			title: 'Bright colour',
			name: 'brightColor',
			description: 'This will be used as the duotone colour (type = duotone) or the logo colour (type = graphic)',
			options: {
		...
		defineField({
			...
			title: 'Earthy colour',
			name: 'earthyColor',
			description: 'This will be used as the logo colour (type = duotone) or the overlay colour (type = graphic)',
			options: {
